...
SECRET_KEY = 'django-insecure-13#(+idzu#5jbg-2i^^qer1l!waip39p42!^0wchigbilvd@@_'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'whatsapp',   # Contraseña que creaste al instalar PostgreSQL
        'HOST': 'localhost',           # Si usas un servidor remoto, cambia esto
